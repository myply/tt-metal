...
struct PackParams {
    ...
    std::array<std::uint32_t, 68> create_pack_cmd() const {
        ...
        cmd[3] = pack_32b_field(tile_id_offset_by_packer, 16, 16) | pack_32b_field(output_tile_id_passthrough, 1, 0);
...
struct StreamConvParams {
    ...
    std::array<std::uint32_t, 8> create_cmd_stream_conv() {
        ...
        cmd[0] = pack_32b_field(CMD_STREAM_CONV_2, 8, 24) | pack_32b_field(kernel_id_unpacker, 8, 16) |
                 pack_32b_field(kernel_id_math, 8, 8) | pack_32b_field(kernel_id_packer, 8, 0);
...
protected:
    ...
    std::array<std::uint32_t, 8> create_cmd_stream_unary_binary_common() {
        ...
        cmd[0] = pack_32b_field(kernel_id_math, 16, 0) | pack_32b_field(math_fidelity, 4, 16) |
                 pack_32b_field(repack_Z_dim_ratio_log2, 3, 20) | pack_32b_field(CMD_STREAM_UNARY_OPERATION, 8, 24);
...
struct StreamPoolParams {
    ...
    std::array<std::uint32_t, 8> create_cmd_stream_pool() {
        ...
        cmd[0] = pack_32b_field(kernel_id_math, 16, 0) | pack_32b_field(math_fidelity, 4, 16) |
                 pack_32b_field(repack_Z_dim_ratio_log2, 3, 20) | pack_32b_field(neginf_srca, 1, 23) |
