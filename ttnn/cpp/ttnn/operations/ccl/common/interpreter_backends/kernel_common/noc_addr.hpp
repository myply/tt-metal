...
safe_get_noc_addr(uint8_t dest_noc_x, uint8_t dest_noc_y, uint32_t dest_bank_addr, uint8_t noc = noc_index) {
    ...
    return get_noc_addr(noc_x, noc_y, dest_bank_addr, noc);
}
