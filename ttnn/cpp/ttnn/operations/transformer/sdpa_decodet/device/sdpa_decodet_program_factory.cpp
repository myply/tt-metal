...
#include "sdpa_decodet_program_factory.hpp"

#include <optional>

#include <tt-metalium/buffer.hpp>
#include "sdpa_decodet_op.hpp"
...
operation::ProgramWithCallbacks sdpa_decodet_multi_core(
    ...
    */
    ...
    // std::cout<<"num_cores_per_head: "<<num_cores_per_head<<std::endl;
    TT_FATAL(
    ...
    auto compute_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/sdpa_decodet/device/kernels/compute/sdpa_flash_decodet.cpp",
        core_grid,
    ...
    auto reader_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/sdpa_decodet/device/kernels/dataflow/reader_decodet_all.cpp",
        core_grid,
    ...
    auto writer_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/sdpa_decodet/device/kernels/dataflow/writer_decodet_all.cpp",
        core_grid,
        ...
        [num_active_cores,
         ...
         is_causal](
            ...
            const auto cur_pos_ids =
                static_cast<const ttnn::operations::transformer::ScaledDotProductAttentionDecodet*>(operation)->cur_pos;
