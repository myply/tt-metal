...
#include "mla_decode1_program_factory.hpp"

#include <optional>

#include <tt-metalium/buffer.hpp>
#include "mla_decode1_op.hpp"
...
operation::ProgramWithCallbacks mla_decode1_multi_core(
    ...
    */
    ...
    auto compute_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/mla_decode1/device/kernels/compute/mla_decode1.cpp",
        core_grid,
    ...
    auto reader_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/mla_decode1/device/kernels/dataflow/reader_mla_decode1_all.cpp",
        core_grid,
    ...
    auto writer_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/mla_decode1/device/kernels/dataflow/writer_mla_decode1_all.cpp",
        core_grid,
        ...
        [num_active_cores,
         ...
         is_causal](
            ...
            const auto cur_pos_ids =
                static_cast<const ttnn::operations::transformer::MultiheadLatentAttentionDecode1*>(operation)->cur_pos;
