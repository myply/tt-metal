...
#include "mla_decode1_pybind.hpp"

#include <pybind11/pybind11.h>
#include <pybind11/stl.h>

#include "mla_decode1.hpp"
#include "cpp/pybind11/decorators.hpp"

namespace ttnn::operations::transformer {

void py_bind_mla_decode1(py::module& module) {
    auto doc =
        R"doc(
    ...
    using OperationType = decltype(ttnn::transformer::multi_head_latent_attention_decode1);
