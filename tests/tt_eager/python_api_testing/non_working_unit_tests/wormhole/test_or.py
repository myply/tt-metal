...
def run_or_test(input_shape, dtype, dlayout, in_mem_config, out_mem_config, data_seed, device):
...
def test_or(input_shape, dtype, dlayout, in_mem_config, out_mem_config, data_seed, device):
    random.seed(0)
    run_or_test(input_shape, dtype, dlayout, in_mem_config, out_mem_config, data_seed, device)
