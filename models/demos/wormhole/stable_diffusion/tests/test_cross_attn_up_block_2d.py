...
def push_input_to_device(input, device, memory_config):
...
def test_cross_attn_up_block_2d_512x512(
    ...
    hidden_state = push_input_to_device(
        hidden_state,
        device,
        ttnn.MemoryConfig(
    ...
    res0 = push_input_to_device(res0, device, ttnn.DRAM_MEMORY_CONFIG)
    res1 = push_input_to_device(res1, device, ttnn.DRAM_MEMORY_CONFIG)
    res2 = push_input_to_device(res2, device, ttnn.DRAM_MEMORY_CONFIG)
    res_hidden_states_tuple = (res0, res1, res2)
