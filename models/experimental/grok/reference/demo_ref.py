...
@torch.no_grad()
def run_grok_demo(user_input, batch_size):
...
def test_ref_demo(user_input="models/demos/grok8x7b/reference/input_data.json", batch_size=32):
    return run_grok_demo(user_input=user_input, batch_size=batch_size)
